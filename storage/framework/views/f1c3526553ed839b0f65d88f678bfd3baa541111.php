    ...
    <div class="row">
      ...
      <div class="col-6">
        <div class="nav-item float-right">
          <a href="<?php echo e(route('players.create')); ?>" type="button" class="btn btn-primary btn-rounded mr-4">
            + Add New Record
          </a>

          <a href="<?php echo e(route('players.report')); ?>" type="button" class="btn btn-success btn-rounded">
           Export to Excel
          </a>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function datatable() {
    $table = $('.yajra-datatable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: `<?php echo e(url('player-list')); ?>`,
      columns: [{
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
          },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\application\TenApp\resources\views/player/index.blade.php ENDPATH**/ ?>